...
def add_overlay(image, angle, lat, long, elevation):
    ...
    overlay_image = cv2.imread('needle2.png', cv2.IMREAD_UNCHANGED)
    ...
    overlay_image1 = cv2.imread('MRM_logo.png', cv2.IMREAD_UNCHANGED)
